...
public class BenchMyCache {


    @Test
    public void bench_same_as_other() {
        ...
        Allocator allocator = new Allocator(500l * 1024l * 1024l);
        ...
        System.out.println("Object size in memory  : " + estimSize * NB_OBJ / 1024 / 1024 + " MB");
